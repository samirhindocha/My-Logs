...
export default function TrendsView({ entries = [], onGoLog, onGoEntry }) {
  const [selectedPeriod, setSelectedPeriod] = useState(PERIOD_OPTIONS[0]); // Default: Last 5 days
  ...
  // Bottom axis labels: evenly-spaced dates spanning the period start through today.
